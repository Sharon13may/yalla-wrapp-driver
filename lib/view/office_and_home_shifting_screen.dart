...
class OfficeAndHomeShiftingScreen extends StatefulWidget {
  const OfficeAndHomeShiftingScreen({super.key});

  @override
  State<OfficeAndHomeShiftingScreen> createState() => _OfficeAndHomeShiftingScreenState();
}

class _OfficeAndHomeShiftingScreenState extends State<OfficeAndHomeShiftingScreen> {
